 ...
 */
class ContactsLists extends BaseModel
{
    // use SoftDeletes;

    use HasFactory;

    public $table = 'contacts_lists';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     **/
    public function FieldsContactsLists()
    {
        return $this->hasMany(\App\Models\FieldsContactsLists::class, 'contacts_lists_id');
    }
}
